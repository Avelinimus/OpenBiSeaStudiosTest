...
namespace Game.Core.Managers
{
    public sealed class HudManager
    {
        ...
        public T ShowSingle<T>(params object[] args) where T : Mediator
        {
            ...
            var prefab = _prefabManager.Get(string.Format(kHudsPath, fileName), _gameView.HudsLayer);
        ...
        public T ShowAdditional<T>(params object[] args) where T : Mediator
        {
            ...
            var prefabResult = _prefabManager.Get(string.Format(kHudsPath, fileName), _gameView.HudsLayer);
